...
inline int8 read_int_8(std::istream& is)
{
  int8 result = 0;
...
inline int16 read_int_16(std::istream& is)
{
  int16 result = 0;
...
inline int32 read_int_32(std::istream& is)
{
  int32 result = 0;
...
inline int64 read_int_64(std::istream& is)
{
  int64 result = 0;
...
inline void read_bytes(std::istream& is, bytes& bytes)
{
...
void read_response(std::istream& is,
