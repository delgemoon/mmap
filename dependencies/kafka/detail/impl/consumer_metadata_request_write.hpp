...
inline int32 request_message_wire_size(const consumer_metadata_request& request)
{
  return string_wire_size(request.consumer_group());
}

inline void write_request_message(const consumer_metadata_request& request,
                                std::ostream& os)
{
