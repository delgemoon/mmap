...
struct offset_fetch_response :
  public response<offset_fetch_response>
{
  ...
  using topics_partitions_t = detail::topics_partitions_map<
...
struct mutable_offset_fetchResponse :
  public mutable_response<offset_fetch_response>
{
public:
  offset_fetch_response::topics_t& mutable_topics();
};
