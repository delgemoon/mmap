...
struct offset_response :
  public response<offset_response>
{
  ...
  using topics_artitions_t = detail::topics_partitions_map<
...
public:
  ...
  partition_t::optional_type TopicPartitionOffset(const std::string& topic_name,
...
struct mutable_offset_response :
  public mutable_response<offset_response>
{
public:
  offset_response::topics_t & mutable_topics();
};
}
