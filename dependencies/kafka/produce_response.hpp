...
struct produce_response: public response<produce_response>
{
  ...
  using topics_partition = detail::topics_partitions_map<
...
public:
  ...
  topic_t find_topic(const std::string& topic_name) const;

  partition_t::optional_type find_topic_partition(const std::string& topic_name,
...
{
public:
  produce_response::topics_t& mutable_topics()
  {
