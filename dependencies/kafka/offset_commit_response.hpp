...
struct offset_commit_response :
  public response<offset_commit_response>
{
...
class mutable_offset_commit_response :
  public mutable_response<offset_commit_response>
{
public:
  offset_commit_response::topics_t& mutable_topics();
};
